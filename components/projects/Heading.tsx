    ...
    >
      ...
      {!tag && (
        <p className="text-fun-gray text-xl sm:text-2xl max-w-3xl m-auto">
          I've built cool apps and websites using anything from HTML to different frameworks
          (Angular, Flutter and even Python!). Here are some of my favorite projects over the course
          of my journey.
        </p>
      )}
    </div>
